...
export const jobAlertTemplate = (user, job) => {
  ...
  return {
    ...
    <body style="margin: 0; padding: 0; font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; background-color: #f8fafc;">
      <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
        <div style="background: linear-gradient(135deg, #ffffff 0%, #f9fafb 100%); border-radius: 24px; box-shadow: 0 20px 40px -10px rgba(0, 0, 0, 0.15); overflow: hidden;">
          
          <div style="background: linear-gradient(135deg, #4f46e5 0%, #7c3aed 100%); padding: 40px 30px; text-align: center;">
            <h1 style="color: white; font-size: 28px; font-weight: 700; margin: 0;">New Job Opportunity! 🎯</h1>
            <p style="color: rgba(255, 255, 255, 0.9); font-size: 16px; margin-top: 10px;">We found a job that matches your skills</p>
          </div>

          <div style="padding: 40px 30px;">
            <p style="color: #1e293b; font-size: 18px; font-weight: 500; margin: 0 0 10px 0;">Hello <span style="color: #4f46e5;">${user.name}</span>,</p>
            <p style="color: #475569; font-size: 16px; line-height: 1.6; margin: 0 0 20px 0;">A new job has been posted that matches your profile:</p>
            
            <div style="background: #f5f3ff; border-radius: 16px; padding: 25px; margin-bottom: 20px;">
              ...
              <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 20px;">
                <div style="background: white; padding: 8px 16px; border-radius: 30px;">
                  <span style="color: #4f46e5;">📍 ${job.location}</span>
                </div>
                <div style="background: white; padding: 8px 16px; border-radius: 30px;">
                  <span style="color: #4f46e5;">💰 ${job.salary}</span>
                </div>
              </div>

              <div style="margin: 25px 0; text-align: center;">
                <a href="${process.env.FRONTEND_URL}/jobs/${job._id}" 
                   style="display: inline-block; background: #4f46e5; color: white; padding: 14px 32px; border-radius: 30px; text-decoration: none; font-weight: 600; font-size: 16px;">
                  View Job Details →
                </a>
              </div>
            </div>
            ...
            <div style="background: #f8fafc; border-radius: 16px; padding: 20px;">
              <h3 style="color: #1e293b; font-size: 16px; font-weight: 600; margin: 0 0 10px 0;">Quick Overview:</h3>
              <p style="color: #64748b; font-size: 14px; margin: 0 0 5px 0;">✓ ${job.description?.overview?.substring(0, 100)}...</p>
              <p style="color: #64748b; font-size: 14px; margin: 0;">✓ ${job.description?.requirements?.length || 0} key requirements to check</p>
            </div>
          </div>

          <div style="background: #f1f5f9; padding: 30px; text-align: center;">
            <p style="color: #475569; font-size: 14px; margin: 0;">Don't miss this opportunity!</p>
          </div>
        </div>
      </div>
    </body>
